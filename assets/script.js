...
const metricUnits = {deg:"C", speed:"Km/h"};
...
function getWeather(city){
    ...
    if(city.country == null){
        ...
        queryURLCurrent = "https://api.openweathermap.org/data/2.5/weather?q="+city.city+","+city.city+"&units=metric&appid="+APIKey;
        queryURLForecast = "https:////api.openweathermap.org/data/2.5/forecast?q="+city.city+","+city.city+"&units=metric&appid="+APIKey;
    }
